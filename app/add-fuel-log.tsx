...
export default function AddFuelLogScreen() {
  ...
  const loadVehicle = async () => {
    try {
      ...
      if (data.type === 'petrol' || data.type === 'diesel' || data.type === 'cng') {
        setFuelType(data.type);
      }
    } catch (error: any) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
            ...
            <View style={styles.typeSelector}>
              {(['petrol', 'diesel', 'cng'] as FuelType[]).map((type) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.typeButton,
                    fuelType === type && styles.typeButtonActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.typeText,
                      fuelType === type && styles.typeTextActive,
                    ]}
                  >
                    {type.toUpperCase()}
                  </Text>
          ...
          <View style={styles.field}>
            <Text style={styles.label}>
              Liters <Text style={styles.required}>*</Text>
            </Text>
            <TextInput
              style={styles.input}
              placeholder="e.g., 35"
